...
#Pendiente porque no funcionan esas pestañas        
    ...
    def inicializar_interfaz_producto(self):
        ...
        entry_nombre_producto = tk.Entry(self.tab_producto)
        ...
        lbl_decripcion_producto = tk.Label(self.tab_producto, text="Descripcion del Producto:")
        lbl_decripcion_producto.grid(row=1, column=0, padx=10, pady=10)
        entry_decripcion_producto = tk.Entry(self.tab_producto)
        ...
        entry_precio_producto = tk.Entry(self.tab_producto)
        ...
        entry_stock = tk.Entry(self.tab_producto)
        ...
        entry_status_producto = tk.Entry(self.tab_producto)
    ...
    def inicializar_interfaz_detalle_venta(self):
        ...
        entry_cantidad = tk.Entry(self.tab_detalle_venta)
        ...
        entry_precio_del_producto = tk.Entry(self.tab_detalle_venta)
        entry_precio_del_producto.grid(row=1, column=1, padx=10, pady=10)
    ...
    def inicializar_interfaz_detalle_reparacion(self):
        ...
        entry_detalle_cantidad = tk.Entry(self.tab_detalle_reparacion)
        entry_detalle_cantidad.grid(row=0, column=1, padx=10, pady=10)
        ...
        entry_detalle_costo = tk.Entry(self.tab_detalle_reparacion)
        entry_detalle_costo.grid(row=1, column=1, padx=10, pady=10)
    ...
    def inicializar_interfaz_cliente(self):
        ...
        entry_nombre_cliente = tk.Entry(self.tab_cliente)
        ...
        entry_direccion = tk.Entry(self.tab_cliente)
        ...
        entry_telefono_cliente = tk.Entry(self.tab_cliente)
        entry_telefono_cliente.grid(row=2, column=1, padx=10, pady=10)
        ...
        entry_correo_cliente = tk.Entry(self.tab_cliente)
        entry_correo_cliente.grid(row=3, column=1, padx=10, pady=10)  
    ...
    def inicializar_interfaz_proveedor(self):
        ...
        entry_proveedor = tk.Entry(self.tab_proveedor)
        ...
        entry_status = tk.Entry(self.tab_proveedor)
        ...
        entry_telefono = tk.Entry(self.tab_proveedor)
        ...
        entry_correo = tk.Entry(self.tab_proveedor)
    ...
    def inicializar_interfaz_reparacion(self):
        ...
        entry_status_reparacion = tk.Entry(self.tab_reparacion)
        entry_status_reparacion.grid(row=0, column=1, padx=10, pady=10)
        ...
        entry_CostoTotal_reparacion = tk.Entry(self.tab_reparacion)
        entry_CostoTotal_reparacion.grid(row=1, column=1, padx=10, pady=10)
    ...
    def inicializar_interfaz_empleados(self):
        ...
        entry_NombreUsuario = tk.Entry(self.tab_empleados)
        entry_NombreUsuario.grid(row=0, column=1, padx=10, pady=10)
        ...
        entry_Contraseña = tk.Entry(self.tab_empleados)
        ...
        entry_Rol = tk.Entry(self.tab_empleados)
        ...
        entry_Status_Usuario = tk.Entry(self.tab_empleados)
        entry_Status_Usuario.grid(row=3, column=1, padx=10, pady=10)
    ...
    def inicializar_interfaz_usuarios(self):
        ...
        lbl_NombreUsuario.grid(row=0, column=0, padx=10, pady=10)
        entry_NombreUsuario = tk.Entry(self.tab_usuarios)
        entry_NombreUsuario.grid(row=0, column=1, padx=10, pady=10)

        # Etiqueta y cuadro de texto para ingresar el contraseña al usuario
        lbl_Contraseña = tk.Label(self.tab_usuarios, text="Contraseña:")
        lbl_Contraseña.grid(row=1, column=0, padx=10, pady=10)
        entry_Contraseña = tk.Entry(self.tab_usuarios)
        entry_Contraseña.grid(row=1, column=1, padx=10, pady=10) 
...
class DBManager:
    ...
    def agregar_producto(self, nombre, descripcion, precio, stock, status):
        ...
        self.cursor.execute("INSERT INTO Producto (Nombre, Descripcion, Precio, Stock, Status, CreadoPor, FechaCreacion, ModificadoPor, FechaModificacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", (nombre, descripcion, precio, stock, status, creadopor, modificado_por, fecha_sqlite))
        self.conexion.commit()
